...
# STarczynski,11.24.2020,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #

# Data ---------------------------------------------------------------------- #
# Declare variables and constants
strFileName = "ToDoFile"  # The name of the data file
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        for dicRow in list_of_rows:
            if task in dicRow["Task"]:
                list_of_rows.remove(dicRow)
                print("Task deleted.")
            elif task not in dicRow["Task"]:
...
class IO:
    ...
    def input_task_to_remove():
        task = str(input("Enter the task you wish to remove: ")).lower().strip()
        return task
        pass
        # return task
...
Processor.read_data_from_file("ToDoFile", lstTable)  # read file data
...
while (True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        # IO sequence collects a new task and priority, Processor adds the new data to the lstTable
        ...
        # IO sequence collects task, Processor sequence removes the task and updates the lstTable
